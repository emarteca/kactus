...
var TEMP_VAR_AUTOGEN582__RANDOM =  FSE.writeFile(filePath, 'b1b2')

expect(inMerge).toEqual(true)

      

 await TEMP_VAR_AUTOGEN582__RANDOM
...
var TEMP_VAR_AUTOGEN620__RANDOM =  FSE.writeFile(firstPath, 'line1\n')

const secondPath = path.join(repo.path, 'second')

      

 await TEMP_VAR_AUTOGEN620__RANDOM

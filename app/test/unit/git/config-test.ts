...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_255_setupFixtureRepository__RANDOM = perf_hooks.performance.now();
 
const testRepoPath = await setupFixtureRepository('test-repo')
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/config-test.ts& [18, 4; 18, 66]& TEMP_VAR_AUTOGEN_CALLING_255_setupFixtureRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_255_setupFixtureRepository__RANDOM));

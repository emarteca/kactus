...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_254_setupFixtureRepository__RANDOM = perf_hooks.performance.now();
 
const testRepoPath = await setupFixtureRepository(
        'repo-with-multiple-remotes'
      )
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/remote-test.ts& [17, 6; 19, 7]& TEMP_VAR_AUTOGEN_CALLING_254_setupFixtureRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_254_setupFixtureRepository__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_277_setupFixtureRepository__RANDOM = perf_hooks.performance.now();
 
const testRepoPath = await setupFixtureRepository(
        'repo-with-multiple-remotes'
      )
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/remote-test.ts& [71, 6; 73, 7]& TEMP_VAR_AUTOGEN_CALLING_277_setupFixtureRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_277_setupFixtureRepository__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_280_setupFixtureRepository__RANDOM = perf_hooks.performance.now();
 
const testRepoPath = await setupFixtureRepository(
        'repo-with-multiple-remotes'
      )
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/remote-test.ts& [83, 6; 85, 7]& TEMP_VAR_AUTOGEN_CALLING_280_setupFixtureRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_280_setupFixtureRepository__RANDOM));

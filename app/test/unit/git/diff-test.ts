...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_267_setupFixtureRepository__RANDOM = perf_hooks.performance.now();
 
const testRepoPath = await setupFixtureRepository('repo-with-image-changes')
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/diff-test.ts& [45, 4; 45, 80]& TEMP_VAR_AUTOGEN_CALLING_267_setupFixtureRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_267_setupFixtureRepository__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_289_setupFixtureRepository__RANDOM = perf_hooks.performance.now();
 
const testRepoPath = await setupFixtureRepository('repo-with-changes')
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/diff-test.ts& [141, 6; 141, 76]& TEMP_VAR_AUTOGEN_CALLING_289_setupFixtureRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_289_setupFixtureRepository__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_292_setupFixtureRepository__RANDOM = perf_hooks.performance.now();
 
const testRepoPath = await setupFixtureRepository('repo-with-changes')
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/diff-test.ts& [160, 6; 160, 76]& TEMP_VAR_AUTOGEN_CALLING_292_setupFixtureRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_292_setupFixtureRepository__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_298_setupFixtureRepository__RANDOM = perf_hooks.performance.now();
 
const repositoryPath = await setupFixtureRepository('diff-rendering-docx')
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/diff-test.ts& [250, 6; 250, 80]& TEMP_VAR_AUTOGEN_CALLING_298_setupFixtureRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_298_setupFixtureRepository__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_300_setupFixtureRepository__RANDOM = perf_hooks.performance.now();
 
const testRepoPath = await setupFixtureRepository('repo-with-changes')
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/diff-test.ts& [414, 8; 414, 78]& TEMP_VAR_AUTOGEN_CALLING_300_setupFixtureRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_300_setupFixtureRepository__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_301_setupFixtureRepository__RANDOM = perf_hooks.performance.now();
 
const testRepoPath = await setupFixtureRepository(
          'repo-with-image-changes'
        )
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/diff-test.ts& [424, 8; 426, 9]& TEMP_VAR_AUTOGEN_CALLING_301_setupFixtureRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_301_setupFixtureRepository__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_302_setupFixtureRepository__RANDOM = perf_hooks.performance.now();
 
const testRepoPath = await setupFixtureRepository(
          'detect-conflict-in-binary-file'
        )
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/diff-test.ts& [440, 8; 442, 9]& TEMP_VAR_AUTOGEN_CALLING_302_setupFixtureRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_302_setupFixtureRepository__RANDOM));

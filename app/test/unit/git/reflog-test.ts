...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_263_setupFixtureRepository__RANDOM = perf_hooks.performance.now();
 
const testRepoPath = await setupFixtureRepository('test-repo')
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/reflog-test.ts& [28, 4; 28, 66]& TEMP_VAR_AUTOGEN_CALLING_263_setupFixtureRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_263_setupFixtureRepository__RANDOM));

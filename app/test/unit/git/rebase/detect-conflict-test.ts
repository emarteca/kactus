...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_925_continueRebase__RANDOM = perf_hooks.performance.now();
 
result = await continueRebase(repository, [], [])
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/rebase/detect-conflict-test.ts& [137, 6; 137, 55]& TEMP_VAR_AUTOGEN_CALLING_925_continueRebase__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_925_continueRebase__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN390__RANDOM = perf_hooks.performance.now();
 await  FSE.writeFile(
        Path.join(repository.path, 'THING.md'),
        '# HELLO WORLD! \nTHINGS GO HERE\nFEATURE BRANCH UNDERWAY\n'
      )
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/rebase/detect-conflict-test.ts& [196, 6; 199, 7]& TEMP_VAR_AUTOGEN390__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN390__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_926_continueRebase__RANDOM = perf_hooks.performance.now();
 
result = await continueRebase(repository, files, [])
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/rebase/detect-conflict-test.ts& [213, 6; 213, 58]& TEMP_VAR_AUTOGEN_CALLING_926_continueRebase__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_926_continueRebase__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_927_continueRebase__RANDOM = perf_hooks.performance.now();
 
result = await continueRebase(repository, files, [])
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/rebase/detect-conflict-test.ts& [288, 6; 288, 58]& TEMP_VAR_AUTOGEN_CALLING_927_continueRebase__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_927_continueRebase__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_928_continueRebase__RANDOM = perf_hooks.performance.now();
 
result = await continueRebase(repository, onlyConflictedFiles, [])
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/rebase/detect-conflict-test.ts& [365, 6; 365, 72]& TEMP_VAR_AUTOGEN_CALLING_928_continueRebase__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_928_continueRebase__RANDOM));

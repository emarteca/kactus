...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_251_setupFixtureRepository__RANDOM = perf_hooks.performance.now();
 
const testRepoPath = await setupFixtureRepository('repo-with-many-refs')
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git/for-each-ref-test.ts& [13, 4; 13, 76]& TEMP_VAR_AUTOGEN_CALLING_251_setupFixtureRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_251_setupFixtureRepository__RANDOM));

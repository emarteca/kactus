...
var TEMP_VAR_AUTOGEN203__RANDOM =  setupFixtureRepository('branch-prune-tests')
...
const path =  await TEMP_VAR_AUTOGEN203__RANDOM
...
var TEMP_VAR_AUTOGEN262__RANDOM =  setupFixtureRepository('branch-prune-tests')
...
const path =  await TEMP_VAR_AUTOGEN262__RANDOM
...
var TEMP_VAR_AUTOGEN300__RANDOM =  setupFixtureRepository('branch-prune-tests')
...
const path =  await TEMP_VAR_AUTOGEN300__RANDOM
...
var TEMP_VAR_AUTOGEN340__RANDOM =  setupFixtureRepository('branch-prune-tests')
...
const path =  await TEMP_VAR_AUTOGEN340__RANDOM

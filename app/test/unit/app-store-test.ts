...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1215__addRepositories__RANDOM = perf_hooks.performance.now();
 
const repositories = await appStore._addRepositories([path])
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/app-store-test.ts& [93, 4; 93, 64]& TEMP_VAR_AUTOGEN_CALLING_1215__addRepositories__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1215__addRepositories__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1217__addRepositories__RANDOM = perf_hooks.performance.now();
 
repo = (await appStore._addRepositories([repo.path]))[0]
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/app-store-test.ts& [189, 8; 189, 64]& TEMP_VAR_AUTOGEN_CALLING_1217__addRepositories__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1217__addRepositories__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1218__addRepositories__RANDOM = perf_hooks.performance.now();
 
repo = (await appStore._addRepositories([repo.path]))[0]
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/app-store-test.ts& [208, 8; 208, 64]& TEMP_VAR_AUTOGEN_CALLING_1218__addRepositories__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1218__addRepositories__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1219__addRepositories__RANDOM = perf_hooks.performance.now();
 
repo = (await appStore._addRepositories([repo.path]))[0]
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/app-store-test.ts& [231, 8; 231, 64]& TEMP_VAR_AUTOGEN_CALLING_1219__addRepositories__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1219__addRepositories__RANDOM));

...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_262_setupFixtureRepository__RANDOM = perf_hooks.performance.now();
 
const path = await setupFixtureRepository('repository-with-105-commits')
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git-store-test.ts& [26, 6; 26, 78]& TEMP_VAR_AUTOGEN_CALLING_262_setupFixtureRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_262_setupFixtureRepository__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN120__RANDOM = perf_hooks.performance.now();
 await  FSE.writeFile(readmeFilePath, 'SOME WORDS GO HERE\n')
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git-store-test.ts& [45, 4; 45, 63]& TEMP_VAR_AUTOGEN120__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN120__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN157__RANDOM = perf_hooks.performance.now();
 await  FSE.writeFile(readmeFilePath, 'WRITING SOME NEW WORDS\n')
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git-store-test.ts& [56, 4; 56, 67]& TEMP_VAR_AUTOGEN157__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN157__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1004_discardChanges__RANDOM = perf_hooks.performance.now();
 

var TIMING_TEMP_VAR_AUTOGEN183__RANDOM = perf_hooks.performance.now();
 await  gitStore.discardChanges([files[1]])
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git-store-test.ts& [68, 4; 68, 45]& TEMP_VAR_AUTOGEN183__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN183__RANDOM));
 
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git-store-test.ts& [68, 4; 68, 45]& TEMP_VAR_AUTOGEN_CALLING_1004_discardChanges__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1004_discardChanges__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1005_discardChanges__RANDOM = perf_hooks.performance.now();
 
await gitStore.discardChanges(filesToDiscard)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git-store-test.ts& [95, 4; 95, 49]& TEMP_VAR_AUTOGEN_CALLING_1005_discardChanges__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1005_discardChanges__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_296_setupFixtureRepository__RANDOM = perf_hooks.performance.now();
 
const path = await setupFixtureRepository('repository-with-HEAD-file')
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git-store-test.ts& [197, 6; 197, 76]& TEMP_VAR_AUTOGEN_CALLING_296_setupFixtureRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_296_setupFixtureRepository__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1006_discardChanges__RANDOM = perf_hooks.performance.now();
 

var TIMING_TEMP_VAR_AUTOGEN412__RANDOM = perf_hooks.performance.now();
 await  gitStore.discardChanges([files[0]])
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git-store-test.ts& [210, 6; 210, 47]& TEMP_VAR_AUTOGEN412__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN412__RANDOM));
 
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/test/unit/git-store-test.ts& [210, 6; 210, 47]& TEMP_VAR_AUTOGEN_CALLING_1006_discardChanges__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1006_discardChanges__RANDOM));

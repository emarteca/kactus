...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_738_log__RANDOM = perf_hooks.performance.now();
 
writeLog(level, message)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/main-process/main.ts& [382, 6; 382, 30]& TEMP_VAR_AUTOGEN_CALLING_738_log__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_738_log__RANDOM));

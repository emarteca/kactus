...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_940_validatePath__RANDOM = perf_hooks.performance.now();
 
this.validatePath()
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/ui/clone-repository/clone-repository.tsx& [188, 6; 188, 25]& TEMP_VAR_AUTOGEN_CALLING_940_validatePath__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_940_validatePath__RANDOM));
...
if (tab === CloneRepositoryTab.Enterprise) 
{
...
var TIMING_TEMP_VAR_AUTOGEN585__RANDOM = perf_hooks.performance.now();
 var AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN585__RANDOM = await  this.validateEmptyFolder(path)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/ui/clone-repository/clone-repository.tsx& [500, 6; 500, 65]& TEMP_VAR_AUTOGEN585__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN585__RANDOM));
 const pathValidation =  AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN585__RANDOM
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_941_validatePath__RANDOM = perf_hooks.performance.now();
 
this.validatePath()
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/ui/clone-repository/clone-repository.tsx& [669, 4; 669, 23]& TEMP_VAR_AUTOGEN_CALLING_941_validatePath__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_941_validatePath__RANDOM));

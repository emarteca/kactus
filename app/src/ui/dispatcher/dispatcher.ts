...
var TEMP_VAR_AUTOGEN611__RANDOM =  this.addRepositories([path], false)
...
const addedRepositories =  await TEMP_VAR_AUTOGEN611__RANDOM
...
var TEMP_VAR_AUTOGEN698__RANDOM_LATER =  installCLI()


      
this.showPopup({ type: PopupType.CLIInstalled })
await TEMP_VAR_AUTOGEN698__RANDOM_LATER

...
export 
class TextDiff extends React.Component<ITextDiffProps, {}> 
{
...
var TIMING_TEMP_VAR_AUTOGEN485__RANDOM = perf_hooks.performance.now();
 var AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN485__RANDOM = await  getFileContents(repository, file, lineFilters)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/ui/diff/text-diff.tsx& [282, 4; 282, 73]& TEMP_VAR_AUTOGEN485__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN485__RANDOM));
 const contents =  AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN485__RANDOM
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_853_initDiffSyntaxMode__RANDOM = perf_hooks.performance.now();
 
this.initDiffSyntaxMode()
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/ui/diff/text-diff.tsx& [533, 4; 533, 29]& TEMP_VAR_AUTOGEN_CALLING_853_initDiffSyntaxMode__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_853_initDiffSyntaxMode__RANDOM));
...
for (
const [className, include]
of Object.entries(classNameInfo))
{
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_854_initDiffSyntaxMode__RANDOM = perf_hooks.performance.now();
 
this.initDiffSyntaxMode()
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/ui/diff/text-diff.tsx& [812, 4; 812, 29]& TEMP_VAR_AUTOGEN_CALLING_854_initDiffSyntaxMode__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_854_initDiffSyntaxMode__RANDOM));

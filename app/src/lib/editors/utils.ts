...
export 
function parse(label: string): ExternalEditor | null 
{
...
export 
async function getAvailableEditors(): Promise<
...
var TIMING_TEMP_VAR_AUTOGEN387__RANDOM = perf_hooks.performance.now();
...
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/editors/utils.ts& [195, 2; 225, 4]& TEMP_VAR_AUTOGEN387__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN387__RANDOM));

...
var TIMING_TEMP_VAR_AUTOGEN505__RANDOM = perf_hooks.performance.now();
 await  remove(storagePath)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/kactus.ts& [308, 4; 308, 29]& TEMP_VAR_AUTOGEN505__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN505__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN528__RANDOM = perf_hooks.performance.now();
 var AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN528__RANDOM = await  Fs.readdir(path)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/kactus.ts& [348, 4; 348, 40]& TEMP_VAR_AUTOGEN528__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN528__RANDOM));
 const names =  AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN528__RANDOM
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_871_getSize__RANDOM = perf_hooks.performance.now();
 
total += await getSize(Path.join(path, name))
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/kactus.ts& [351, 6; 351, 51]& TEMP_VAR_AUTOGEN_CALLING_871_getSize__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_871_getSize__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_872_getSize__RANDOM = perf_hooks.performance.now();
 
return await getSize(storageRootPath)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/kactus.ts& [357, 2; 357, 39]& TEMP_VAR_AUTOGEN_CALLING_872_getSize__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_872_getSize__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN543__RANDOM = perf_hooks.performance.now();
 var AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN543__RANDOM = await  Fs.readdir(storageRootPath)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/kactus.ts& [374, 2; 374, 49]& TEMP_VAR_AUTOGEN543__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN543__RANDOM));
 const repos =  AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN543__RANDOM
...
var TIMING_TEMP_VAR_AUTOGEN553__RANDOM = perf_hooks.performance.now();
 await  Fs.remove(commitishCachePath)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/kactus.ts& [389, 12; 389, 47]& TEMP_VAR_AUTOGEN553__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN553__RANDOM));

...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1047_getSelectedExternalEditor__RANDOM = perf_hooks.performance.now();
 

var TIMING_TEMP_VAR_AUTOGEN696__RANDOM = perf_hooks.performance.now();
 var AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN696__RANDOM = await  this.getSelectedExternalEditor()
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [1745, 4; 1745, 70]& TEMP_VAR_AUTOGEN696__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN696__RANDOM));
 const externalEditorValue =  AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN696__RANDOM
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [1745, 4; 1745, 70]& TEMP_VAR_AUTOGEN_CALLING_1047_getSelectedExternalEditor__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1047_getSelectedExternalEditor__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN699__RANDOM = perf_hooks.performance.now();
 var AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN699__RANDOM = await  getCachedAvailableEditors()
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [1803, 4; 1803, 53]& TEMP_VAR_AUTOGEN699__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN699__RANDOM));
 const editors =  AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN699__RANDOM
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1054__loadStatus__RANDOM = perf_hooks.performance.now();
 
await this._loadStatus(repository, {
        skipParsingModifiedSketchFiles: true,
      })
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [2228, 6; 2230, 8]& TEMP_VAR_AUTOGEN_CALLING_1054__loadStatus__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1054__loadStatus__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1055__loadStatus__RANDOM = perf_hooks.performance.now();
 
await this._loadStatus(repository, {
        skipParsingModifiedSketchFiles: true,
      })
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [2243, 6; 2245, 8]& TEMP_VAR_AUTOGEN_CALLING_1055__loadStatus__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1055__loadStatus__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1056__loadStatus__RANDOM = perf_hooks.performance.now();
...
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [2885, 4; 2888, 51]& TEMP_VAR_AUTOGEN_CALLING_1056__loadStatus__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1056__loadStatus__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1057__loadStatus__RANDOM = perf_hooks.performance.now();
 
const status = await this._loadStatus(repository, options)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [2922, 4; 2922, 62]& TEMP_VAR_AUTOGEN_CALLING_1057__loadStatus__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1057__loadStatus__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1169_refreshIndicatorForRepository__RANDOM = perf_hooks.performance.now();
 
await this.refreshIndicatorForRepository(repo)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [3022, 6; 3022, 52]& TEMP_VAR_AUTOGEN_CALLING_1169_refreshIndicatorForRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1169_refreshIndicatorForRepository__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_611_inferLastPushForRepository__RANDOM = perf_hooks.performance.now();
 

var TIMING_TEMP_VAR_AUTOGEN731__RANDOM = perf_hooks.performance.now();
 var AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN731__RANDOM = await  inferLastPushForRepository(
      this.accounts,
      gitStore,
      repository
    )
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [3063, 4; 3067, 5]& TEMP_VAR_AUTOGEN731__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN731__RANDOM));
 const lastPush =  AWAIT_VAR_TIMING_TEMP_VAR_AUTOGEN731__RANDOM
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [3063, 4; 3067, 5]& TEMP_VAR_AUTOGEN_CALLING_611_inferLastPushForRepository__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_611_inferLastPushForRepository__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1058__loadStatus__RANDOM = perf_hooks.performance.now();
 
await this._loadStatus(repository, {
        clearPartialState: options.clearPartialState,
      })
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [3092, 6; 3094, 8]& TEMP_VAR_AUTOGEN_CALLING_1058__loadStatus__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1058__loadStatus__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1196__checkoutBranch__RANDOM = perf_hooks.performance.now();
...
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [3241, 4; 3248, 5]& TEMP_VAR_AUTOGEN_CALLING_1196__checkoutBranch__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1196__checkoutBranch__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN739__RANDOM = perf_hooks.performance.now();
...
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [3294, 12; 3299, 13]& TEMP_VAR_AUTOGEN739__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN739__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN743__RANDOM = perf_hooks.performance.now();
 await  this._updateKactusFilesAfterCheckout(
          repository,
          previousKactusState
        )
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [3426, 8; 3429, 9]& TEMP_VAR_AUTOGEN743__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN743__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN751__RANDOM = perf_hooks.performance.now();
 await  this._updateKactusFilesAfterCheckout(
            repository,
            previousKactusState
          )
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [4078, 10; 4081, 11]& TEMP_VAR_AUTOGEN751__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN751__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1007_discardChanges__RANDOM = perf_hooks.performance.now();
 

var TIMING_TEMP_VAR_AUTOGEN754__RANDOM = perf_hooks.performance.now();
 await  gitStore.discardChanges(files)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [4226, 4; 4226, 40]& TEMP_VAR_AUTOGEN754__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN754__RANDOM));
 
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [4226, 4; 4226, 40]& TEMP_VAR_AUTOGEN_CALLING_1007_discardChanges__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1007_discardChanges__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_814_getRebaseSnapshot__RANDOM = perf_hooks.performance.now();
 
var TIMING_TEMP_VAR_AUTOGEN_CALLING_806_getRebaseSnapshot__RANDOM = perf_hooks.performance.now();
 
var TIMING_TEMP_VAR_AUTOGEN_CALLING_782_getRebaseSnapshot__RANDOM = perf_hooks.performance.now();
 
const snapshot = await getRebaseSnapshot(repository)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [4529, 4; 4529, 56]& TEMP_VAR_AUTOGEN_CALLING_782_getRebaseSnapshot__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_782_getRebaseSnapshot__RANDOM));
 
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [4529, 4; 4529, 56]& TEMP_VAR_AUTOGEN_CALLING_806_getRebaseSnapshot__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_806_getRebaseSnapshot__RANDOM));
 
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [4529, 4; 4529, 56]& TEMP_VAR_AUTOGEN_CALLING_814_getRebaseSnapshot__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_814_getRebaseSnapshot__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1059__loadStatus__RANDOM = perf_hooks.performance.now();
 
await this._loadStatus(repository, {
      skipParsingModifiedSketchFiles: true,
    })
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [5009, 4; 5011, 6]& TEMP_VAR_AUTOGEN_CALLING_1059__loadStatus__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1059__loadStatus__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_914_clearKactusCache__RANDOM = perf_hooks.performance.now();
 
var TIMING_TEMP_VAR_AUTOGEN_CALLING_890_clearKactusCache__RANDOM = perf_hooks.performance.now();
 
var TIMING_TEMP_VAR_AUTOGEN_CALLING_878_clearKactusCache__RANDOM = perf_hooks.performance.now();
 
await clearKactusCache(undefined, String(id))
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [5222, 6; 5222, 51]& TEMP_VAR_AUTOGEN_CALLING_878_clearKactusCache__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_878_clearKactusCache__RANDOM));
 
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [5222, 6; 5222, 51]& TEMP_VAR_AUTOGEN_CALLING_890_clearKactusCache__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_890_clearKactusCache__RANDOM));
 
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [5222, 6; 5222, 51]& TEMP_VAR_AUTOGEN_CALLING_914_clearKactusCache__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_914_clearKactusCache__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_915_clearKactusCache__RANDOM = perf_hooks.performance.now();
 
var TIMING_TEMP_VAR_AUTOGEN_CALLING_891_clearKactusCache__RANDOM = perf_hooks.performance.now();
 
var TIMING_TEMP_VAR_AUTOGEN_CALLING_879_clearKactusCache__RANDOM = perf_hooks.performance.now();
 
return clearKactusCache(
      new Date(Date.now() - this.kactusClearCacheInterval)
    )
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [5329, 4; 5331, 5]& TEMP_VAR_AUTOGEN_CALLING_879_clearKactusCache__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_879_clearKactusCache__RANDOM));
 
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [5329, 4; 5331, 5]& TEMP_VAR_AUTOGEN_CALLING_891_clearKactusCache__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_891_clearKactusCache__RANDOM));
 
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [5329, 4; 5331, 5]& TEMP_VAR_AUTOGEN_CALLING_915_clearKactusCache__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_915_clearKactusCache__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1060__loadStatus__RANDOM = perf_hooks.performance.now();
 
await this._loadStatus(repository, {
      skipParsingModifiedSketchFiles: true,
    })
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [5685, 4; 5687, 6]& TEMP_VAR_AUTOGEN_CALLING_1060__loadStatus__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1060__loadStatus__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1197__checkoutBranch__RANDOM = perf_hooks.performance.now();
 
await this._checkoutBranch(repository, head.ref)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [5723, 6; 5723, 54]& TEMP_VAR_AUTOGEN_CALLING_1197__checkoutBranch__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1197__checkoutBranch__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1198__checkoutBranch__RANDOM = perf_hooks.performance.now();
 
await this._checkoutBranch(repository, localBranchName)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [5765, 6; 5765, 61]& TEMP_VAR_AUTOGEN_CALLING_1198__checkoutBranch__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1198__checkoutBranch__RANDOM));
...
var TIMING_TEMP_VAR_AUTOGEN_CALLING_1199__checkoutBranch__RANDOM = perf_hooks.performance.now();
 
await this._checkoutBranch(repository, branchToCheckout, strategy)
console.log("/home/ellen/Documents/ASJProj/TESTING_reordering/kactus/app/src/lib/stores/app-store.ts& [5930, 4; 5930, 70]& TEMP_VAR_AUTOGEN_CALLING_1199__checkoutBranch__RANDOM& " + (perf_hooks.performance.now() - TIMING_TEMP_VAR_AUTOGEN_CALLING_1199__checkoutBranch__RANDOM));
